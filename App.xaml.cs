...
public delegate void DebugPrintsHandler(string debugPrints);
    ...
    public event DebugPrintsHandler DebugPrintsUpdated;
        ...
        {
            string action = await Application.Current.MainPage.DisplayActionSheet("", "Cancel", null,
                "Button Box",
                "Generic Digital", 
                "Generic Diesel", 
                "Generic Fast",
                "Ford Focus 2015 ( 220 / 6500 )", 
                "Ford Focus 2015 diesel ( 240 / 5000 )",
                "VW Polo  ( 240 / 5500 )",
                "BMW M2  ( 300 / 8000 )", 
                "BMW M8 2020  ( 330 / 8000 )",
                "Mercedes W124 1990  ( 260 / 7000 )", 
                "Mercedes S 2008  ( 260 / 7000 )", 
                "Mercedes S 2015  ( 260 / 8000 )",
                "Mercedes AMG 2021  ( 360 / 8000 )", 
                "Debug");
            switch (action)
            {
                case "Cancel":
            ...
            await Application.Current.MainPage.DisplayAlert("", "Not yet implemented...", "OK");
        }
    }
}
